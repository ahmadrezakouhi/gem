...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('drivers', function (Blueprint $table) {
            ...
            $table->string('CertificateNumber',20)->nullable();      // CertificateNumber
            ...
            $table->char('CertificateIssueCityCode',10)->nullable(); // CertificateIssueCityCode
            $table->string('CertificateIssueCityName')->nullable();  // CertificateIssueCityName
