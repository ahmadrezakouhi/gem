...
class BillOfLadingFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'Bill_Description' => Faker::paragraph(),
            'Bill_Status' => fake()->numberBetween(1, 4),
            'Bill_AfterDelivered' => getRandomCost(10),
            'Bill_UserId' => $user->id,
