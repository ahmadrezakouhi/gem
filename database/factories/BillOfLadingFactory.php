...
class BillOfLadingFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'Bill_SignatureUser' => 'nothing for now',
            ...
            'S_OriginTitle' => $sender->city_title,
            'S_Address' => $sender->addresses()->first()->address,
            ...
            'R_DestinationTitle' => $receiver->city_title,
            'R_Address' => $receiver->addresses()->first()->address,
            ...
            'N_PelakSeries' => $vehicle->number_plate_zone,
            ...
            'N_VehicleTypeCode' => fake()->numerify('#######'),
